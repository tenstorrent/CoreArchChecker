...
TEST_F(CacTest, BasicCoreTest){
    ...
    threadT tid0 = 0;
    threadT tid1 = 1;
    SetRegister(CAC_STATE_PC_ID, 0, {0xcafe0000});
    SetRegister(CAC_STATE_PC_ID, 1, {0xcafe0008});
    SetRegister(CAC_STATE_RegX0_ID, 0, {0xbeefbeef});
    SetRegister(CAC_STATE_RegX0_ID, 1, {0xdeadbeef});
    // Single hart
    // Hart 0 Step 1
    // From Simulator:
    cbd.updateRefRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 0));
    // Direct using state ID
    cbd.updateRefRegister(tid0, CAC_STATE_RegX0_ID, GetRegister(CAC_STATE_RegX0_ID, 0));
    // Using encoding and offset
    cbd.updateRefRegister(tid0, REGISTER_RT_FIX_ENCODING, 1, GetRegister(CAC_STATE_RegX0_ID, 0));
    // From Dut:
    cbd.updateRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 0));
    cbd.updateRegister(tid0, CAC_STATE_RegX0_ID, GetRegister(CAC_STATE_RegX0_ID, 0));
    cbd.updateRegister(tid0,  REGISTER_RT_FIX_ENCODING, 1, GetRegister(CAC_STATE_RegX0_ID, 0));
    cbd.step(tid0);
    ...
    cbd.updateRefRegister(tid0, REGISTER_RT_FLT_ENCODING, 6, GetRegister(CAC_STATE_RegX0_ID, 1));
    // From Dut:
    ...
    cbd.updateRegister(tid0, REGISTER_RT_FLT_ENCODING, 6, GetRegister(CAC_STATE_RegX0_ID, 1));
    cbd.step(tid0);
...
TEST_F(CacTest, VectorRegistersTest) {
    ...
    SetRegister(CAC_STATE_PC_ID, 0, {0xcafe0000});
    SetRegister(CAC_STATE_PC_ID, 1, {0xcafe0008});
    SetRegister(CAC_STATE_RegX0_ID, 0, {0xbeefbeef,0xdeaddead});
    SetRegister(CAC_STATE_RegX0_ID, 1, {0xbeefbeef,0xdeaddead});
    SetRegister(CAC_STATE_RegX0_ID, 2, {0xdeadbeef,0xbeefdead});
    SetRegister(CAC_STATE_RegX0_ID, 3, {0xabcdefffffffff,0x1234567800000000});
    SetRegister(CAC_STATE_RegX0_ID, 4, {0xcafe0020cafe0028, 0xcafe0030cafe0038, 0xcafe0040cafe0048, 0xcafe0050cafe0058});
    SetRegister(CAC_STATE_RegX0_ID, 5, {0x0, 0x0, 0xcafe0020cafe0028, 0xcafe0030cafe0038});
    SetRegister(CAC_STATE_RegX0_ID, 6, {0xcafe0020cafe0028, 0xcafe0030cafe0038, 0xcafe0040cafe0048, 0xcafe0050cafe0058, 0xcafe0020cafe0068, 0xcafe0030cafe0078, 0xcafe0040cafe0088, 0xcafe0050cafe0098});
    SetRegister(CAC_STATE_RegX0_ID, 7, {0xcafe0020cafe0028, 0xcafe0030cafe0038, 0xcafe0040cafe0048, 0xcafe0050cafe0058, 0x0, 0x0, 0xcafe0040cafe0088, 0xcafe0050cafe0098});
    // step 1
    //From Simulator:
    cac.updateRefRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 0));
    cac.updateRefRegister(tid0, CAC_STATE_RegV0_ID, GetRegister(CAC_STATE_RegX0_ID, 0));
    //From DUT
    cac.updateRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 0));
    cac.updateRegister(tid0, CAC_STATE_RegV0_ID, GetRegister(CAC_STATE_RegX0_ID, 0));
    //Single Step
    cac.step(tid0);
    ...
    cac.updateRefRegister(tid0, REGISTER_RT_VEC_ENCODING, 31, GetRegister(CAC_STATE_RegX0_ID, 1));
    //From DUT
    cac.updateRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 1));
    cac.updateRegister(tid0, REGISTER_RT_VEC_ENCODING, 31, GetRegister(CAC_STATE_RegX0_ID, 1));
    //Single Step
    cac.step(tid0);
    EXPECT_TRUE(cac.getStatus(tid0));
    //step 3
    //From Simulator:
    cac.updateRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 0));
    cac.updateRegister(tid0, REGISTER_RT_VEC_ENCODING, 1, GetRegister(CAC_STATE_RegX0_ID, 2));
    //From DUT
    cac.updateRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 0));
    cac.updateRefRegister(tid0, REGISTER_RT_VEC_ENCODING, 2, GetRegister(CAC_STATE_RegX0_ID, 2));
    //Single Step
    cac.step(tid0);
    ...
    //From Simulator:
    cac.updateRefRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 0));
    cac.updateRefRegister(tid0, REGISTER_RT_VEC_ENCODING, 20, GetRegister(CAC_STATE_RegX0_ID, 2));
    //From DUT
    cac.updateRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 0));
    cac.updateRegister(tid0, REGISTER_RT_VEC_ENCODING, 20, GetRegister(CAC_STATE_RegX0_ID, 0));
    //Single Step
    cac.step(tid0);
    EXPECT_FALSE(cac.getStatus(tid0));
    cac.resetStatus(tid0);
    ...
    cac.updateRefRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 1));
    cac.updateRegister(tid0, REGISTER_RT_VEC_ENCODING, 21, GetRegister(CAC_STATE_RegX0_ID, 4));
    //From DUT
    cac.updateRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 1));
    cac.updateRefRegister(tid0, REGISTER_RT_VEC_ENCODING, 21, GetRegister(CAC_STATE_RegX0_ID, 4));
    //Single Step
    cac.step(tid0);
    EXPECT_TRUE(cac.getStatus(tid0));
    cac.resetStatus(tid0);
    ...
    //From Simulator:
    cac.updateRefRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 1));
    cac.updateRefRegister(tid0, REGISTER_RT_VEC_ENCODING, 22, GetRegister(CAC_STATE_RegX0_ID, 5));
    //From DUT
    cac.updateRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 1));
    cac.updateRegister(tid0, REGISTER_RT_VEC_ENCODING, 22, GetRegister(CAC_STATE_RegX0_ID, 4));
    //Single Step
    cac.step(tid0);
    EXPECT_FALSE(cac.getStatus(tid0));
    cac.resetStatus(tid0);
    ...
    cac.updateRefRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 1));
    cac.updateRegister(tid0, REGISTER_RT_VEC_ENCODING, 23, GetRegister(CAC_STATE_RegX0_ID, 6));
    //From DUT
    cac.updateRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 1));
    cac.updateRefRegister(tid0, REGISTER_RT_VEC_ENCODING, 23, GetRegister(CAC_STATE_RegX0_ID, 6));
    //Single Step
    cac.step(tid0);
    EXPECT_TRUE(cac.getStatus(tid0));
    cac.resetStatus(tid0);
    ...
    //From Simulator:
    cac.updateRefRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 0));
    cac.updateRegister(tid0, REGISTER_RT_VEC_ENCODING, 24, GetRegister(CAC_STATE_RegX0_ID, 6));
    //From DUT
    cac.updateRegister(tid0, CAC_STATE_PC_ID, GetRegister(CAC_STATE_PC_ID, 0));
    cac.updateRefRegister(tid0, REGISTER_RT_VEC_ENCODING, 24, GetRegister(CAC_STATE_RegX0_ID, 7));
    //Single Step
    cac.step(tid0);
    EXPECT_FALSE(cac.getStatus(tid0));
    cac.resetStatus(tid0);
